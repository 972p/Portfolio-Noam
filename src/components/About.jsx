        ...
        <section id="about">
            ...
            <div className="terminal">
                ...
                <div className="terminal-body">
                    <span className="terminal-command">cat a_propos.txt</span>
                    ...
                    <span className="terminal-command">cat projet_pro.txt</span>
                    <div className="terminal-output">
                    ...
                    <span className="terminal-command">executer generer_objectifs.sh</span>
                    <div className="terminal-output">
