            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="cyber-box" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                    <div>
                        ...
                        <p className="text-secondary mb-4" style={{ fontSize: '0.9rem' }}>Format PDF - BTS SIO 2026 - MOUHOUBI Noam</p>
                    </div>
                    <a href="/8 - ANNEXE VI.1 - EPREUVE E5 TABLEAU DE SYNTHESE - BTS SIO 2026 MOUHOUBI Noam.pdf" download="8 - ANNEXE VI.1 - EPREUVE E5 TABLEAU DE SYNTHESE - BTS SIO 2026 MOUHOUBI Noam.pdf" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', color: 'var(--neon-green)', textDecoration: 'none', border: '1px solid var(--neon-green)', padding: '0.5rem 1rem', width: 'max-content', transition: 'all 0.3s ease' }}>
                        <span style={{ fontSize: '0.9rem' }}>&gt; TÉLÉCHARGER_FICHIER</span>
                    </a>
                </div>
            </div>
        </section>
